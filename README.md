# Reason Rust Scraper
This is a code repository for implementing how to scraping and crawling websites using [Rust](http://rustlang.org/), and [ReasonML](https://reasonml.github.io/). This project was originally made by me with the aim of tools in my company to work. However, because of the sudden change of ideas and concepts finally i make it like this hehe, as well as my first project when learning & use ReasonML.
